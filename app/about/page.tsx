...
export default function AboutPage() {
  ...
  if (!mounted) {
    return (
      <main
        className="relative overflow-x-hidden bg-background pt-16"
        style={{ height: vh, minHeight: "-webkit-fill-available" }}
      >
        <div className="fixed top-0 left-0 w-full z-[100] bg-background/80 backdrop-blur-xl border-b border-border">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <div className="text-xl font-bold text-[#f59e0b] tracking-tighter">
              SD.
            </div>
            <div className="lg:hidden p-2 ml-auto text-primary rounded-lg">
              <div className="w-6 h-0.5 bg-muted-foreground mb-1.5"></div>
              <div className="w-6 h-0.5 bg-muted-foreground mb-1.5"></div>
        ...
        <section className="px-6 py-16 md:py-32 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-4">
              <div className="h-4 bg-muted/20 w-24 rounded"></div>
              <div className="h-12 bg-muted/20 rounded w-3/4"></div>
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <section
        className={`relative ${spacing.section} ${spacing.py.section} pt-20 md:pt-32`}
      >
        {/* Animated Background Elements - Contained with will-change-transform */}
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={fadeUp}>
              ...
              <motion.div
                variants={fadeUp}
                className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8 will-change-auto"
              >
                {personalStats.map((stat, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-card rounded-lg p-4 border border-border will-change-transform"
                    >
            ...
            >
              <motion.div
                ...
                style={{ willChange: "transform" }}
              />
              <div className="relative p-8 bg-card border border-border h-full rounded-3xl overflow-hidden">
                    ...
                    <div className="flex justify-center gap-4 mt-6">
                      {[Github, Linkedin, Mail].map((Icon, index) => (
                        <motion.a
                          ...
                          whileTap={{ scale: 0.9 }}
                          className="p-3 rounded-xl bg-muted hover:bg-accent transition-colors will-change-transform"
                        >
      ...
      <section
        className={`${spacing.section} ${spacing.py.section} bg-muted/30 relative will-change-auto`}
      >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {developmentPrinciples.map((principle, index) => {
                ...
                return (
                  ...
                  >
                    <div className="card p-8 bg-card border border-border rounded-xl hover:border-[#f59e0b]/30 transition-all duration-300 h-full overflow-hidden">
                      <motion.div
      ...
      {/* Technical Expertise */}
      <section
        className={`${spacing.section} ${spacing.py.section} relative will-change-auto`}
      >
        <div className={spacing.container}>
          <motion.div
            initial="hidden"
              ...
              {techStack.map((tech, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group will-change-transform"
                  >
                    <div className="card p-6 bg-card border border-border rounded-lg hover:border-[#f59e0b]/50 transition-all duration-300 overflow-hidden">
                      <div className="flex flex-col items-center text-center">
                        <motion.div
                          className="p-3 rounded-xl mb-4 group-hover:scale-110 transition-transform duration-300 will-change-transform"
                  ...
                  {timeline.map((item, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="relative pl-12 will-change-auto"
                      >
                        <motion.div
                        ...
                        <div className="pb-8 border-l border-border ml-5 pl-8 overflow-hidden">
                          <motion.div
                ...
                <div className="space-y-6">
                  {keyProjects.map((project, index) => (
                    <motion.div
                      ...
                      whileHover={{ y: -5 }}
                      className="card p-6 bg-card border border-border rounded-lg hover:border-[#f59e0b]/50 transition-all duration-300 will-change-transform overflow-hidden"
                    >
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {project.tech.map((t, i) => (
                          <motion.span
                            ...
                            className="px-3 py-1 text-xs bg-muted rounded-lg text-muted-foreground will-change-transform"
                          >
                            {t}
                          </motion.span>
                        ))}
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <motion.div
                      ...
                      transition={{ delay: index * 0.1 }}
                      whileHover={{ x: 5 }}
                      className="flex items-center gap-3 p-4 rounded-xl bg-card border border-border will-change-transform overflow-hidden"
                    >
      ...
      {/* Final CTA */}
      <section className={`${spacing.section} pb-32 relative will-change-auto`}>
        <div className={spacing.container}>
          <motion.div
            initial="hidden"
            whileInView="show"
          ...
          >
            <motion.div
              variants={scaleIn}
              className="relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-card via-card to-muted/20 will-change-auto"
            >
              {/* Animated background */}
              <motion.div
              ...
              <div className="relative z-10 p-12 lg:p-16">
                <motion.div
                  variants={floatAnimation}
                  className="inline-flex p-4 rounded-2xl bg-gradient-to-r from-[#f59e0b]/10 to-[#3B82F6]/10 mb-8 will-change-transform"
                >
